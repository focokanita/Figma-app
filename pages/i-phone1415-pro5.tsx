...
import styles from "./i-phone1415-pro5.module.css";

const IPhone1415Pro5: NextPage = () => {
  return (
    <div className={styles.iphone1415Pro16}>
      ...
      <div className={styles.iphone1415Pro16Child} />
